void main() {
  ...
  print("""Vemos q pasa con los conjuntos(SET)
  convertimos el ITERABLE en un SET usando .toSET: ${numerosAlreves.toSet()}
  podemos visualizar el resultado que el set a eliminado los duplicados y ahora delimita 
  los datos usando ().
  """);
  ...
  Resultado con el filtro : ${numerosMayoresAs}
  """);
